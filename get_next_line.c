...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/06/10 00:18:34 by mamuller          #+#    #+#             */
/*   Updated: 2021/06/10 00:18:34 by mamuller         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*
gcc -Wall -Wextra -Werror -D BUFFER_SIZE=32 get_next_line.c get_next_line_utils.c
clang -Wall -Wextra -Werror -Wnon-literal-null-conversion -D BUFFER_SIZE=32
...
int	get_next_line_prev(int fd, char **line)
{
	...
	{
		tmp = ft_strjoin(tmp, (char *)&buffer[0], 1);
		ft_memmove_till_newline((char *)&buffer[0]);
	}
	else if (bytes > 0)
		tmp = ft_strjoin(tmp, (char *)&buffer[0], 0);
	*line = tmp;
